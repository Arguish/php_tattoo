...
<div class="container-fluid mt-4">
    <h2 class="text-light mb-4 bg-dark p-3 rounded">Gestión de Reservas <span><a href="reportPdf.php" class="btn btn-primary ">Descargar</a></span></h2>
    <?php if (in_array($_SESSION['usuario_rol'], ['cliente',])): ?>
        <div>
        ...
        fetch(`../../services/reservas.php?target=reservas&action=create`, {
            ...
            .then(response => {
                if (response.ok) {
                    ...
                    alert('No puedes reservas mas citas por ahora');
                }
            })
    }
